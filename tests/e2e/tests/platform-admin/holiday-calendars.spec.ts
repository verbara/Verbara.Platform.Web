...
test.describe('Holiday Calendars', () => {
  ...
  test('should display holiday calendars page', async ({ platformAdminPage: page }) => {
  ...
  test('should create a calendar', async ({ platformAdminPage: page, authenticatedApiContext }) => {
  ...
  test('should delete a calendar with 3s confirmation', async ({ platformAdminPage: page, authenticatedApiContext }) => {
    const api = new ApiHelper(authenticatedApiContext);
